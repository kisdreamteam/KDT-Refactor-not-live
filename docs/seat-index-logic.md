...
- **SeatingLogic Service (Layer 2):** All math above (Coordinate conversion, Next Index calculation) should be centralized in `src/features/seating/services/seatingLogic.ts`.